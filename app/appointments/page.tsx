  ...
  const handleBookAppointment = async () => {
    ...
    bookAppointmentMutation.mutate(
      ...
      },
      {
        ...
        onError: (error: any) => toast.error(`Failed to book appointment: ${error.message}`),
      }
    );
  };
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        ...
        {currentStep === 1 && <DoctorSelectionStep selectedDentistId={selectedDentistId} onContinue={() => setCurrentStep(2)} onSelectDentist={handleSelectDentist} />}
              ...
              <div key={appointment.id} className="bg-card border rounded-lg p-4 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  <div className="size-10 bg-primary/10 rounded-full flex items-center justify-center">
                    <img src={appointment.doctorImageUrl} alt={appointment.doctorName} className="size-10 rounded-full" />
                  </div>
                  <div>
