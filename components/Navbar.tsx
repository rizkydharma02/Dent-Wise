      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center h-full">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href={'/appointments'} className={`flex items-center gap-2 transition-colors hover:text-foreground ${pathname === '/appointments' ? 'text-foreground' : 'text-muted-foreground'}`}>
              <CalendarIcon className="w-4 h-4" />
              <span className="hidden md:inline">Appointments</span>
            </Link>
            <Link href={'/appointments'} className={`flex items-center gap-2 transition-colors hover:text-foreground ${pathname === '/voice' ? 'text-foreground' : 'text-muted-foreground'}`}>
              <MicIcon className="w-4 h-4" />
              <span className="hidden md:inline">Voice</span>
            </Link>
            <Link href={'/appointments'} className={`flex items-center gap-2 transition-colors hover:text-foreground ${pathname === '/pro' ? 'text-foreground' : 'text-muted-foreground'}`}>
